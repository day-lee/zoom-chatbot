  ...
  return (
    <AvatarFirstMsg>
      <span>
        ...
        may be disabled without warning. Click{" "}
        <strong>Request an Appeal</strong> below to submit an appeal to Zoom's
...
export const ReactivateAccountCustomMsg = () => {
  return (
    <div className="react-chatbot-kit-chat-bot-message-container">
      <div className="react-chatbot-kit-chat-bot-message">
        Click <strong>Reactivate Account</strong> below ⬇️ for instructions to
        provide to your account owner or admins.
      </div>
    </div>
  );
};
...
export const ResetPasswordCustomMsg = () => {
  return (
    <div className="react-chatbot-kit-chat-bot-message-container">
      <div className="react-chatbot-kit-chat-bot-message">
        <span>
          Please wait 30 minutes and attempt to sign in to your Zoom account
          again. If you are not sure what your password is, select{" "}
          <strong>Reset Password</strong> below ⬇️
        </span>
      </div>
    </div>
  );
...
export const ResetPassword2CustomMsg = () => {
  return (
    <AvatarFirstMsg>
      <span>
        Click the <strong>Reset Password</strong> button below to start
...
export const ResetPassword2NoteCustomMsg = () => {
  return (
    <div className="react-chatbot-kit-chat-bot-message-container">
      <div className="react-chatbot-kit-chat-bot-message">
        <i>
          <strong>Note</strong>: For SSO accounts please contact your IT admin
          for assistance.
        </i>
      </div>
    </div>
  ...
  return (
    <AvatarFirstMsg>
      <span>
        ...
        <br></br>
        <i>
          <strong>Note</strong>: To continue following instructions here, select
          the <span className="text-red-600">Help</span> icon on the Reset
          Password page. <br></br>
          <br></br>
        </i>
        <ul className="list-disc pl-10">
          <li>
            Enter your registered email address in the{" "}
            <strong>Email Address</strong> field
          </li>
          <li>
            Click the <strong>I'm not a robot</strong> checkbox to complete the
        ...
        Check your email inbox and spam folders. Did you receive a verification
        email?
      </span>
    </AvatarFirstMsg>
  );
